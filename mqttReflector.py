...
## anavi/ea14e76e308ff50a0e09a7e5bf96749a/air/heatindex
...
def on_message_temperature(mosq, obj, msg):
	...
	value = j["temperature"]; 
        epoch_time = int (time.time())
        message = '{"dateTime":'+str(epoch_time)+', "inTemp" : '+str(value)+'}'
    	rc = mosq.publish("weather", message);
	print("Message is :"+message);
	print("rc is :"+str(rc));
...
def on_connect(client, userdata, flags, rc):
	...
	mqtt_topics = ["anavi/ea14e76e308ff50a0e09a7e5bf96749a/#"]; 
...
#mqttc.message_callback_add('anavi/ea14e76e308ff50a0e09a7e5bf96749a/air/heatindex', on_message_heatindex)
